...
<%@include file="../../includes/cabecera.jsp"%>   
    ...
    <!-- Page Header Start -->
      <div class="inner cover-container">
        <h3 class="cover-heading">Listado de Encendido</h3>
     
        <table class="table table-hover">
            <tr class="bg-light text-gray"><th>Programacion<th>Fecha<th>Hora Inicio<th>Hora Fin<th>Temp. Max<th>Temp. Min<th>Hora Enc.<th>Temp. Enc.<th>Programador<th>

             <%
               String nro=(String)request.getAttribute("dato");
               Negocio obj=new Negocio();
               for(Especial x:obj.lisRegEnc(nro)){
               out.print("<tr class=bg-light><td>"+x.getTxt1()+"<td>"+x.getTxt2()+"<td>"+x.getTxt3()+"<td>"+
               x.getTxt4()+"<td>"+x.getTxt5()+"<td>"+x.getTxt6()+"<td>"+x.getTxt7()+"<td>"+x.getTxt8()+"<td>"+x.getTxt9()+"<td>");
                  }
                 %>

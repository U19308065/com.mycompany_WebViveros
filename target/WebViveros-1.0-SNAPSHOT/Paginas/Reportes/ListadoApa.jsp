...
<%@include file="../../includes/cabecera.jsp"%>   
    ...
    <!-- Page Header Start -->
      <div class="inner cover-container">
        <h3 class="cover-heading">Listado de Apagado</h3>
     
        <table class="table table-hover">
            <tr class="bg-light text-gray"><th>Programacion<th>Fecha<th>Hora Inicio<th>Hora Fin<th>Temp. Max<th>Temp. Min<th>Hora Apa.<th>Temp. Apa.<th>Programador<th>

             <%
               String nro=(String)request.getAttribute("dato");
               Negocio obj=new Negocio();
               for(Especial x:obj.lisRegApa(nro)){
